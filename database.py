...
user_db_file_location = os.path.join(PROJECT_ROOT, 'database_file', 'users.db')
note_db_file_location = os.path.join(PROJECT_ROOT, 'database_file', 'notes.db')
image_db_file_location = os.path.join(PROJECT_ROOT, 'database_file', 'images.db')
